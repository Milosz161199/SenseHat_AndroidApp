...
public class Common {
    ...
    public static String DEFAULT_IP_ADDRESS = "192.168.100.22";
    public final static String DEFAULT_CONFIG_IP_ADDRESS = "192.168.100.22";
    ...
    public static int DEFAULT_MAX_NUMBER_OF_SAMPLES = 1000;
    public final static int DEFAULT_CONFIG_MAX_NUMBER_OF_SAMPLES = 1000;
